...
export default function ChemicalsToPaper() {
  ...
  return (
    <>
      ...
      <section ref={chemRef} className="section-py-md relative w-full bg-paper">
        <div className="container-industrial">
          <span className="font-label mb-8 block text-ink/50">Línea química</span>
          ...
          <div className="relative mt-10 grid grid-cols-1 gap-8 md:grid-cols-[1fr_1.6fr] md:items-center md:gap-16">
            ...
            <div className="chem-item relative h-[42vh] w-full overflow-hidden md:-mr-12 md:h-[48vh] min-[1440px]:-mr-20!">
              <PhotoMedia
